...
function AboutUs() {
  return (
    <div className="flex flex-col md:flex-row bg-black">
      <div className="h-1/2 w-full md:w-auto">
        <img src="/images/ordinateur_logo.png" alt="Image" className="my-6 mx-auto md:mx-0" />
      </div>
      <div className="border-l-4 grid content-baseline">
        <div className="text-white">
          <h2 className="mt-4 ml-8 md:ml-80 text-3xl md:text-4xl">
            <b>About Us</b>
          </h2>
        </div>
        <div>
          <p className="mx-4 mt-4 md:mx-10 text-white">
