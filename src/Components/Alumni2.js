...
function Alumni2() {
  const[adata, setadata]=useState(alumnidata)
    ...
    <div className='pb-11 pl-9 h-96 overflow-y-scroll'>
        <div className='place-self-center '>
      <table class="table-fixed max-w-full">
  <thead className='bg-red-600 transition ease-in-out delay-150 shadow-xl hover:scale-110'>
    <tr>
  ...
  <tbody className=' text-black py-7'>
  {adata.map((items)=> (
