...
function Core_team(){
    return(
        ...
        <ul className='grid text-sky-500 list-disc m-4 group-hover:border-solid border-2 p-2 rounded-lg bg-zinc-900 hover:border-sky-500 '><b><u>Student Coordinator</u></b>
          <a href='https://www.linkedin.com/in/4shreyassingh5/' target="_blank" rel="noreferrer" className='ml-4 m-4 text-white'><b>President:</b> Shreyas Singh</a>
          <a href='https://www.linkedin.com/in/paramjeet-bamaniya-230160226/' target="_blank" rel="noreferrer" className='ml-4 m-4 text-white'><b>Vice President:</b> Paramjeet Bamaniya</a>
          <a href='https://www.linkedin.com/in/akansha-bharti/' target="_blank" rel="noreferrer" className='ml-4 m-4  text-white'><b>General Secretary:</b> Akansha Bharti</a>
          <a href='https://www.linkedin.com/in/ankit-kanojiya-242a15225/' target="_blank" rel="noreferrer" className='ml-4 m-4 text-white'><b>Treasurer:</b> Ankit</a>
        </ul>
